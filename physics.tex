...
\begin{frame}{Representation of $H$}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{triangle3d-H}
	\caption{Representation of $H$ over the config space triangle.}
\end{figure}
\end{frame}

\begin{frame}{Representation of $T$}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{triangle3d-T}
	\caption{Representation of $T$ over the config space triangle.}
\end{figure}
\end{frame}

\begin{frame}{Representation of $s_\ell$}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{triangle3d-sL}
	\caption{Representation of $H$ over the config space triangle.}
\end{figure}
