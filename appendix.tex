...
\begin{frame}{Size of the system for $H$}
	Noting that $N-2 = \frac{3C}{L}$
	\[
		H = -\frac{3C}{L}M_\ell.\label{eq:H_M}
	\]
	and
	\[
		H = -\frac{3C}{L}L\tanh \left(\frac{N-2}{T}\right). 
	\]
\end{frame}

\subsection{More Temperature figures}
\begin{frame}{Logarithm of $T$}
 \begin{figure}
    \centering
...
\begin{frame}{Representation of $1/T$}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{triangle3d-1T.pdf}
	\caption{Representation of $\frac{1}{T}$ over the config space triangle.}
\end{figure}	
\end{frame}


\begin{frame}{Entropy in terms of magnetization}
\begin{equation}
...
\begin{frame}{Link entropy and link magnetization}
 \begin{figure}
     \centering
...
\begin{frame}{Triangle entropy and triangle magnetization}
 \begin{figure}[!h]
     \centering
...
\begin{frame}{Link magnetization}
\begin{figure}[h]
    \centering
...
\begin{frame}{Triangle magnetization}
\begin{figure}[h]
    \centering
